...
export interface ApiAchatlivreAchatlivre extends Struct.CollectionTypeSchema {
...
export interface ApiAdministrationAdministration
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    signalement: Schema.Attribute.Boolean;
    titre: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEditionEdition extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    achatlivres: Schema.Attribute.Relation<
      'manyToMany',
      'api::achatlivre.achatlivre'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiOeuvreOeuvre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    licence: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::oeuvre.oeuvre'
    ...
    titre: Schema.Attribute.String;
    titrealt: Schema.Attribute.Text;
    traduction: Schema.Attribute.Text;
...
export interface ApiProprietaireProprietaire
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bullInfo: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    infovalidation: Schema.Attribute.Boolean;
    join: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::proprietaire.proprietaire'
    > &
      Schema.Attribute.Private;
    oeuvresvalide: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    ...
    validationAdmin: Schema.Attribute.Boolean;
  };
}
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    etat: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    oeuvres: Schema.Attribute.Relation<'manyToMany', 'api::oeuvre.oeuvre'>;
    publishedAt: Schema.Attribute.DateTime;
    teamliens: Schema.Attribute.Relation<
      'manyToMany',
      'api::teamlien.teamlien'
    >;
...
export interface ApiTeamlienTeamlien extends Struct.CollectionTypeSchema {
  collectionName: 'teamliens';
  info: {
    description: '';
    displayName: 'teamlien';
    pluralName: 'teamliens';
    singularName: 'teamlien';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    indexeur: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    ...
    profil: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    proprietaire: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    provider: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    restreint: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::teamlien.teamlien': ApiTeamlienTeamlien;
